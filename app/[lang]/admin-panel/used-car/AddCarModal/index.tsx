...
import UploadImagesComponet from '@/app/[lang]/components/UploadImagesComponent'
        ...
        <Layer zIndex={modalZIndex}>
          ...
          >
            <Fragment>
              ...
              <div className='row align-items-baseline pt-3'>
              ...
              <h6 className='fw-bold mb-0 pt-3'>Екстериор</h6>
              <div className='row'>
                <Flex
                  alignItems='center'
                  gap={4}
              ...
              <h6 className='fw-bold mb-0 pt-3'>Комфорт</h6>
              <div className='row'>
                <Flex
                  alignItems='center'
                  gap={4}
              ...
              <h6 className='fw-bold mb-0 pt-3'>Други</h6>
              <div className='row'>
                <Flex
                  alignItems='center'
                  gap={4}
