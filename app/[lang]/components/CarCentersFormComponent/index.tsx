...
import "./carCentersFormComponent.scss";
...
export default function CarCentersFormComponent({
  translations,
  title,
}: {
  title: string;
  ...
  const [hasTakenTimeValidationError, setHasTakenTimeValidationError] =
    useState(false);
      ...
      if (file) {
        ...
        try {
          ...
          if (response.status === 200) {
            ...
            setHasTakenTimeValidationError(false);
            setShowToast(true);
            // console.log("response", response);
          }
        } catch (error) {
          if (
            error.response.data.message === "The date has already been taken."
          ) {
            setHasTakenTimeValidationError(true);
          }
        }
      }
    }
  ...
  return (
    <Suspense fallback={<Loader />}>
      <div className="pb-3">
        {messageValidation && (
          <Box alignItems="center" display="flex" height="100%" paddingY={8}>
            <BannerSlim
        ...
        <div className="contact-wrapper">
          ...
          <div className="description-contact pageContent">
            ...
            <div className="row">
              ...
              <div className="col-md-4">
                <Box marginBottom={6}>
                  <Label className="text-left" htmlFor="year">
                    {translations.year}
                  </Label>
                ...
                <div className="row align-items-center">
                  <div className="col-md-8">
                    <DatePicker
                      ...
                      value={date}
                      errorMessage={
                        !hasDateValidationError ? undefined : translations.date
                      }
                    />
                  </div>
                  <div className="col-md-4">
                    ...
                    <TimePicker
                      className={
                        hasTimeValidationError || hasTakenTimeValidationError
                          ? "error-input"
                          : ""
                      }
                      status={
                              ...
                              <div role="alert" className="zI7 iyn Hsu">
                                <div className="KS5 hs0 un8 tkf A6h">
                                  ...
                                  <div className="xuA">
                                    ...
                                    {hasTakenTimeValidationError &&
                                      translations.hour_taken_validation}
                                  </div>
                                </div>
                              </div>
                            </span>
