...
import CarDealershipComponent from "../components/CarDealershipComponent";
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: `${process.env.NODE_ENV !== "production" ? process.env.LOCALHOST_SITE_URL : process.env.SITE_URL}/car-dealership/car-centers`,
  },
  other: {
...
export default async function CarDealership({
  params,
}: {
  params: { lang: Locale };
}) {
  ...
  return (
    <Suspense fallback={<Loader />}>
      <CarDealershipComponent translations={navigation} />
    </Suspense>
  );
}
