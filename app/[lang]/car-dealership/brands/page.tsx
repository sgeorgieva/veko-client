import BrandsComponent from "../../components/CarDealershipComponent/BrandsComponent";
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: `${process.env.NODE_ENV !== "production" ? process.env.LOCALHOST_SITE_URL : process.env.SITE_URL}/car-dealership/brands`,
  },
  other: {
...
export default async function Brands({ params }: { params: { lang: Locale } }) {
  const { page } = await getDictionary(params.lang);

  return <BrandsComponent translations={page.brands} />;
}
