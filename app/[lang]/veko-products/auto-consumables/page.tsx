...
import AutoConsumablesComponent from "../../components/VekoProductsComponent/AutoConsumablesComponent";
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: `${process.env.NODE_ENV !== "production" ? process.env.LOCALHOST_SITE_URL : process.env.SITE_URL}/trade/auto-consumables`,
  },
  other: {
...
export default async function AutoConsumables({
  params,
}: {
  params: { lang: Locale };
}) {
  ...
  return (
    <Suspense fallback={<Loader />}>
      <AutoConsumablesComponent
        title={navigation.autoconsumables}
