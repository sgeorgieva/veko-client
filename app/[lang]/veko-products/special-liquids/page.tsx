...
import SpecialLiquidsComponent from "../../components/VekoProductsComponent/SpecialLiquidsComponent";
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: `${process.env.NODE_ENV !== "production" ? process.env.LOCALHOST_SITE_URL : process.env.SITE_URL}/trade/special-liquids`,
  },
  other: {
