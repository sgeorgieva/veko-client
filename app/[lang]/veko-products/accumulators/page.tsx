...
import AccumulatorsComponent from "../../components/VekoProductsComponent/AccumulatorsComponent";
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: `${process.env.NODE_ENV !== "production" ? process.env.LOCALHOST_SITE_URL : process.env.SITE_URL}/trade/accumulators`,
  },
  other: {
...
export default async function Accumulators({
  params,
}: {
  params: { lang: Locale };
}) {
