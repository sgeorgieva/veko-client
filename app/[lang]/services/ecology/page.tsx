...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: `${process.env.NODE_ENV !== "production" ? process.env.LOCALHOST_SITE_URL : process.env.SITE_URL}/services/ecology`,
  },
  other: {
...
export default async function Ecology({
  params,
}: {
  params: { lang: Locale };
}) {
  ...
  return (
    <Suspense fallback={<Loader />}>
      <EcologyComponent
        title={navigation.ecology}
        translations={page.ecology}
      />
    </Suspense>
  );
}
