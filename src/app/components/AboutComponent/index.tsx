        ...
        component={
          <div className="contact-wrapper">
            ...
            <div className="description-contact pageContent">
              <p>
                &ldquo;Веко ойл&ldquo; ЕООД е основана на 19 февруари 1997 г. в гр. Русе с
                основен предмет на дейност продажба на петролни продукти,
                химикали, автоаксесоари и автокозметика. Фирмата развива и
                автосервизна дейност – от профилактика до основен ремонт на леки
                и лекотоварни автомобили. &ldquo;Веко ойл&ldquo; ЕООД е основен дистрибутор
                за Централна и Североизточна България на световноизвестни марки
                петролни продукти, както и на продуктите на различни реномирани
                производители и вносители.
              </p>
              <p>
                От 2007 г. &ldquo;Веко ойл&ldquo; ЕООД е
                официален представител на автомобилните марки &ldquo;SUBARU&ldquo; и &ldquo;KIA&ldquo;
              ...
              <p className="fw-bold text-uppercase">
                Ние не продаваме просто стоки, а удовлетворяваме конкретни потребности.
              </p>
