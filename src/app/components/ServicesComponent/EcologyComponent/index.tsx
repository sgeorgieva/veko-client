            ...
            <div className="description-contact pageContent">
              <div className={`row ${isMobile ? "flex-column-reverse" : ""}`}>
                <div className="col-md-9">
                  <p>
                    &ldquo;ВЕКО ОЙЛ&ldquo; ЕООД притежава разрешително №
                    010-ДО-686-00 от 14.06.2012 г. от РИОСВ – гр. Русе за
                    извършване на дейности по събиране, временно съхранение и
                    транспортиране на отпадъци на териториятана цялата страна.
                    Фирмата предлага консултации, изготвяне на документи по ЗУО,
                    сключване на договор за отпадъци с лицензирана фирма.
                    Дружеството има разработена програма за дейностите по
                    управление на следните видове отпадъци:
                  </p>
                  <ul>
                    <li>
                      приемане на отработени /отпадъчни/ масла от крайния
                      потребител, и от площадките за временно съхранение на
                      масла, които са образувани в резултат на експлоатацията на
                      техниката и оборудването на юридическите лица,
                      код:13.02.05*, 13.02.06*, 13.02.08*, 13.01.10*, 13.01.11*,
                      13.01.13*, 13.03.07*, 13.03.08*, 13.03.10*,
                      13.05.06*,13.05.07*;
                    </li>
                    <li>
                    ...
                    <li>
                      абсорбенти, филтърни материали , кърпи за изтриване и
                  ...
                  <p>
                    Фирмените площадки за временно съхранение на отработени
                    масла са с местонахождение както следва:
                  </p>
                  <ul>
                    <li>
