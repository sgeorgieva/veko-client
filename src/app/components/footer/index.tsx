    ...
    <div className={`footer ${classname === 'light-background' ? 'dark-text' : ''}`}>
      <div className="d-flex align-items-center justify-content-around">
        ...
        <div className="d-flex flex-column">
          ...
          <AnimatedLink href="/contact" hasActiveClass={pathname == '/contact' ? true : false}>Контакти</AnimatedLink>
          <div className="social-icons">
            <Link target="_blank" href="https://www.facebook.com/AutocenterVEKO">
              <Icon
                color="#2b2b2b"
                inline={true}
                icon="facebook"
            ...
            <Link target="_blank" href="https://www.youtube.com/@vekooilltd.7582" className="ps-1">
              <Icon
                color="#2b2b2b"
                inline={true}
                icon="youtube"
