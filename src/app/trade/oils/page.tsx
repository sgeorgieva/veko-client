...
import OilsComponent from '@/app/components/OilsComponent';
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: `${process.env.NODE_ENV !== 'production' ? process.env.LOCALHOST_SITE_URL : process.env.SITE_URL}/oils`,
  },
  other: {
